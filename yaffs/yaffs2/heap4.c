/*
 * http://svnmios.midibox.org/listing.php?repname=svn.mios32&path=%2Ftrunk%2FFreeRTOS%2FSource%2Fportable%2FMemMang%2F&rev=2375&peg=2#
...
unsigned char *pucHeapEnd, *pucAlignedHeap;
	...
	while( ( ( ( unsigned long ) pxEnd ) & ( ( unsigned long ) portBYTE_ALIGNMENT_MASK ) ) != 0UL );
	pxEnd->xBlockSize = 0;
