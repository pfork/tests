...
# Title: Top Block
# Generated: Sun Mar 22 03:35:06 2015
##################################################
...
class top_block(grc_wxgui.top_block_gui):
    ...
    def __init__(self):
        ...
        self.channel_spacing = channel_spacing = 400000
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, "/tmp/a", False)
        ...
        self.connect((self.freq_xlating_fir_filter_xxx_0_1, 0), (self.analog_quadrature_demod_cf_0, 0))
        ...
        self.connect((self.blocks_char_to_float_0, 0), (self.wxgui_scopesink2_0_0, 1))
