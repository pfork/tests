...
# Title: Top Block
# Generated: Sat Mar 21 02:44:00 2015
##################################################
...
class top_block(grc_wxgui.top_block_gui):
    ...
    def __init__(self):
        ...
        self.low_pass_filter_0 = filter.fir_filter_ccf(1, firdes.low_pass(
        	1, samp_rate, 40e3, 10000, firdes.WIN_BLACKMAN, 6.76))
        ...
        self.connect((self.analog_quadrature_demod_cf_0, 0), (self.blocks_add_const_vxx_1, 0))
        self.connect((self.blocks_add_const_vxx_1, 0), (self.blocks_float_to_uchar_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 40e3, 10000, firdes.WIN_BLACKMAN, 6.76))
    ...
    def set_offset(self, offset):
        ...
        self.blocks_add_const_vxx_1.set_k((self.offset, ))
