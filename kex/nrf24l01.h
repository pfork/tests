...
unsigned char nrf_write_buf(unsigned char reg, unsigned char *pBuf, unsigned char bytes);
void nrf24_init(void);
void nrf_open(uint8_t chan, unsigned char* tx_address, uint8_t rx);
void nrf_send(unsigned char * tx_buf, unsigned char tx_buf_len);
char nrf_recv(unsigned char * buf, unsigned char buf_len);
